...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Personal site of Prashant Panta — HPC researcher, writer, builder." },
      { name: "author", content: "Prashant Panta" },
      { property: "og:title", content: "Prashant Panta" },
      { property: "og:description", content: "HPC researcher, writer, builder." },
